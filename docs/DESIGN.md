...
> :factory: **Think of it like an assembly line.** A car chassis enters at one end. Each station does one job -- welds, paints, installs -- and passes it forward. No station talks to another. No station sends the car backward. At the end, a finished car comes out.
...
The contract matrix and stage contracts feed the rules and enforcement tiers in `CONTRIBUTING.md`.

---

## Step 3 -- Design Components

> :bricks: One brick, one shape. Need "and" to describe it? Split it.
