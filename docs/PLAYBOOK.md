...
| --- | --- | --- | --- |
| `src/web/rss.py` | 29 | 93 | 1.00 |
| `src/catalog.py` | 22 | 93 | 0.76 |
| `src/app_common.py` | 29 | 56 | 0.60 |
| `src/youtube/ytdlp.py` | 12 | 58 | 0.26 |
| `src/models/metadata.py` | 18 | 37 | 0.25 |
| `src/youtube/auth.py` | 16 | 36 | 0.21 |
| `src/youtube/metadata.py` | 13 | 33 | 0.16 |
| `src/utils/cache.py` | 12 | 17 | 0.08 |
| `src/app_runner.py` | 7 | 17 | 0.04 |
| `src/utils/text.py` | 5 | 14 | 0.03 |
