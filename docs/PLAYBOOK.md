...
| --- | --- | --- | --- |
| `src/web/rss.py` | 27 | 121 | 1.00 |
| `src/catalog.py` | 20 | 100 | 0.61 |
| `src/app_common.py` | 26 | 58 | 0.46 |
| `src/youtube/ytdlp.py` | 11 | 58 | 0.20 |
| `src/models/metadata.py` | 16 | 37 | 0.18 |
| `src/youtube/auth.py` | 15 | 36 | 0.17 |
| `src/youtube/metadata.py` | 12 | 33 | 0.12 |
| `src/utils/crypto.py` | 9 | 25 | 0.07 |
| `src/utils/cache.py` | 10 | 20 | 0.06 |
| `src/app_runner.py` | 6 | 17 | 0.03 |
