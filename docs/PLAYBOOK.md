...
| --- | --- | --- | --- |
| `src/web/rss.py` | 28 | 93 | 1.00 |
| `src/catalog.py` | 21 | 93 | 0.75 |
| `src/app_common.py` | 28 | 56 | 0.60 |
| `src/youtube/ytdlp.py` | 11 | 58 | 0.25 |
| `src/models/metadata.py` | 17 | 37 | 0.24 |
| `src/youtube/auth.py` | 15 | 36 | 0.21 |
| `src/youtube/metadata.py` | 12 | 33 | 0.15 |
| `src/utils/cache.py` | 11 | 17 | 0.07 |
