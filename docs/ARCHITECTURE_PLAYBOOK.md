...
| --- | --- | --- | --- |
| `src/web/rss.py` | 8 | 114 | 0.89 |
| `src/catalog.py` | 9 | 86 | 0.75 |
| `src/files/s3.py` | 7 | 68 | 0.46 |
| `src/app_common.py` | 7 | 28 | 0.19 |
| `src/youtube/auth.py` | 5 | 36 | 0.18 |
| `src/youtube/downloader.py` | 5 | 36 | 0.18 |
| `src/utils/cache.py` | 3 | 49 | 0.14 |
| `src/youtube/metadata.py` | 4 | 36 | 0.14 |
| `src/files/audio.py` | 4 | 34 | 0.13 |
| `src/utils/crypto.py` | 4 | 25 | 0.10 |
