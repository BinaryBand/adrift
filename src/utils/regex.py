...
YT_CHANNEL = re_compile(
    rf"^https?://(www\.)?youtube\.com/@([A-Za-z0-9_\-]+)(/videos)?$"
)

YOUTUBE_PLAYLIST_REGEX = re_compile(
    rf"^https?://(www\.)?youtube\.com/playlist\?list=([A-Za-z0-9_\-]+)$"
)

YT_CHANNEL_SHORTHAND = re_compile(rf"^yt://@([A-Za-z0-9_\-]+)$")
YOUTUBE_PLAYLIST_SHORTHAND_REGEX = re_compile(rf"^yt://#([A-Za-z0-9_\-]+)$")
