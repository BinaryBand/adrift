...
Usage:
    python runbook/build_diagram.py            # write to playbook
    python runbook/build_diagram.py --print    # print to stdout only
    python runbook/build_diagram.py --check    # exit 1 if playbook is stale
"""
...
_INTRO = (
    ...
    "This diagram is generated by `runbook/build_diagram.py`"
    " — do not edit by hand."
)
