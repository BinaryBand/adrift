...
from adrift.services.youtube.ytdlp import (
...
class TestFetchVideoInfoRaw(unittest.TestCase):
    ...
    @patch("adrift.services.youtube.ytdlp.YoutubeDL")
    @patch("adrift.services.youtube.ytdlp.get_auth_ydl_opts")
    @patch("adrift.services.youtube.ytdlp.get_ydl_opts")
...
class TestFetchVideoInfo(unittest.TestCase):
    ...
    @patch("adrift.services.youtube.ytdlp._fetch_video_info_raw")
    @patch("adrift.services.youtube.ytdlp._CACHE")
...
class TestGetCachedChannelInfo(unittest.TestCase):
    ...
    @patch("adrift.services.youtube.ytdlp._fetch_channel_info_raw")
    @patch("adrift.services.youtube.ytdlp._CACHE")
    ...
    @patch("adrift.services.youtube.ytdlp.random")
    @patch("adrift.services.youtube.ytdlp._fetch_channel_info_raw")
    @patch("adrift.services.youtube.ytdlp._CACHE")
...
class TestGetYoutubeVideos(unittest.TestCase):
    ...
    @patch("adrift.services.youtube.ytdlp._fetch_video_batch")
    @patch("adrift.services.youtube.ytdlp._CACHE")
    @patch("adrift.services.youtube.ytdlp._utcnow")
