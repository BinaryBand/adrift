...
from adrift.adapters.youtube.ytdlp import (
...
class TestFetchVideoInfoRaw(unittest.TestCase):
    ...
    @patch("adrift.adapters.youtube.ytdlp.YoutubeDL")
    @patch("adrift.adapters.youtube.ytdlp.get_auth_ydl_opts")
    @patch("adrift.adapters.youtube.ytdlp.get_ydl_opts")
    ...
    @patch("adrift.adapters.youtube.ytdlp.get_auth_ydl_opts")
    @patch("adrift.adapters.youtube.ytdlp.get_ydl_opts")
    @patch("adrift.adapters.youtube.ytdlp._CACHE")
...
class TestFetchVideoInfo(unittest.TestCase):
    ...
    @patch("adrift.adapters.youtube.ytdlp._fetch_video_info_raw")
    @patch("adrift.adapters.youtube.ytdlp._CACHE")
...
class TestGetCachedChannelInfo(unittest.TestCase):
    ...
    @patch("adrift.adapters.youtube.ytdlp._fetch_channel_info_raw")
    @patch("adrift.adapters.youtube.ytdlp._CACHE")
    ...
    @patch("adrift.adapters.youtube.ytdlp.random")
    @patch("adrift.adapters.youtube.ytdlp._fetch_channel_info_raw")
    @patch("adrift.adapters.youtube.ytdlp._CACHE")
...
class TestGetYoutubeVideos(unittest.TestCase):
    ...
    @patch("adrift.adapters.youtube.ytdlp._fetch_video_batch")
    @patch("adrift.adapters.youtube.ytdlp._CACHE")
    ...
    @patch("adrift.adapters.youtube.ytdlp._fetch_video_batch")
    @patch("adrift.adapters.youtube.ytdlp._CACHE")
    @patch("adrift.adapters.youtube.ytdlp._utcnow")
