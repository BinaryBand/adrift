...
class TestGetYoutubeVideosCache(unittest.TestCase):
    ...
    @patch("adrift.adapters.youtube.metadata._normalize_youtube_link")
    @patch("adrift.adapters.youtube.ytdlp.get_youtube_videos")
...
class TestGetYoutubeVideosFilter(unittest.TestCase):
    ...
    @patch("adrift.adapters.youtube.metadata._normalize_youtube_link")
    @patch("adrift.adapters.youtube.ytdlp.get_youtube_videos")
    @patch("adrift.adapters.youtube.metadata.re_compile")
...
class TestGetYoutubeVideosDetailed(unittest.TestCase):
    ...
    @patch("adrift.adapters.youtube.metadata._normalize_youtube_link")
    @patch("adrift.adapters.youtube.ytdlp.get_youtube_videos")
    @patch("adrift.adapters.youtube.metadata._add_episode_metadata")
