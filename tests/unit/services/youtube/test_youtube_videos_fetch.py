...
from adrift.services.youtube.metadata import YtFetchOptions, get_youtube_episodes


class TestGetYoutubeVideosCache(unittest.TestCase):
    """Test caching behavior of get_youtube_episodes."""

    @patch("adrift.services.youtube.metadata._normalize_youtube_link")
    @patch("adrift.services.youtube.ytdlp.get_youtube_videos")
...
class TestGetYoutubeVideosFilter(unittest.TestCase):
    ...
    @patch("adrift.services.youtube.metadata._normalize_youtube_link")
    @patch("adrift.services.youtube.ytdlp.get_youtube_videos")
    @patch("adrift.services.youtube.metadata.re_compile")
...
class TestGetYoutubeVideosDetailed(unittest.TestCase):
    ...
    @patch("adrift.services.youtube.metadata._normalize_youtube_link")
    @patch("adrift.services.youtube.ytdlp.get_youtube_videos")
    @patch("adrift.services.youtube.metadata._add_episode_metadata")
