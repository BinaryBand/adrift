...
from adrift.core.models import YtDlpImage
from adrift.core.util.image import (
...
class TestExtractImageFromFeedparser(unittest.TestCase):
    ...
    def test_empty_string_returns_empty(self):
        assert extract_image_from_feedparser("") == ""

    def test_none_returns_empty(self):
        assert extract_image_from_feedparser(None) == ""
    ...
    def test_dict_prefers_href_over_url(self):
        ...
        assert result == "https://href.example.com/"

    def test_dict_with_no_image_keys_returns_empty(self):
        assert extract_image_from_feedparser({"title": "foo"}) == ""

    def test_object_with_href_attr(self):
        obj = _AttrObj(href="https://attr-href.example.com/img.jpg")
        assert extract_image_from_feedparser(obj) == "https://attr-href.example.com/img.jpg"

    def test_object_with_url_attr(self):
        obj = _AttrObj(url="https://attr-url.example.com/img.jpg")
        assert extract_image_from_feedparser(obj) == "https://attr-url.example.com/img.jpg"

    def test_integer_returns_empty(self):
        assert extract_image_from_feedparser(42) == ""
...
class TestExtractImageFromYtdlp(unittest.TestCase):
    def test_ytdlp_image_model(self):
        ...
        assert extract_image_from_ytdlp(img) == "https://yt.example.com/thumb.jpg"

    def test_ytdlp_image_model_none_url(self):
        img = YtDlpImage(url=None)
        assert extract_image_from_ytdlp(img) == ""
    ...
    def test_raw_dict_without_url_returns_empty(self):
        assert extract_image_from_ytdlp({"width": 120}) == ""

    def test_none_returns_empty(self):
        assert extract_image_from_ytdlp(None) == ""

    def test_string_returns_empty(self):
        assert extract_image_from_ytdlp("https://string.example.com/") == ""


class TestExtractImageFromYtdlpList(unittest.TestCase):
    def test_empty_list_returns_empty(self):
        assert extract_image_from_ytdlp_list([]) == ""

    def test_single_entry_returns_its_url(self):
        img = YtDlpImage(url="https://single.example.com/img.jpg")
        assert extract_image_from_ytdlp_list([img]) == "https://single.example.com/img.jpg"
    ...
    def test_returns_last_entry(self):
        ...
        assert extract_image_from_ytdlp_list(imgs) == "https://last.example.com/"

    def test_list_of_dicts(self):
        data = [{"url": "https://first.example.com/"}, {"url": "https://last.example.com/"}]
        assert extract_image_from_ytdlp_list(data) == "https://last.example.com/"
